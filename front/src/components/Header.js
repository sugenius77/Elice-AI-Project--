              ...
              <li className="list-none mx-2 p-1">
                <div className="dropdown">
                  <button
                    ...
                    type="button"
                    className="flex z-10 items-center border-transparent rounded-full focus:border-blue-500 focus:ring-opacity-40 focus:ring-blue-300  focus:ring cursor-not-allowe"
                  >
                    <img
