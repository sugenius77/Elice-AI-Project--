                    ...
                    <div className="mt-5">
                      <div className="flex">
                        <button
                          ...
                          onClick={() =>
                            window.open(detail.hotel_url, "_blank")
                          }
                        >
                          예약 바로가기
                        </button>
                        <span className="ml-1">
                          <HeartButton hotel_id={hotel_id} is_wish={is_wish} />
                        </span>
                      </div>
                      <div className="font-notoSans my-5">
                        <DetailKeywords
                          data={detail.positive_keywords}
                          positive={true}
                        />
                        <DetailKeywords data={detail.negative_keywords} />
                      </div>
                    </div>
                  </div>
                </div>
